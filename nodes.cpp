...
namespace pluto
{
    ...
    AddNode::AddNode(std::shared_ptr<Node> node_a, std::shared_ptr<Node> node_b)
    ...
    SubtractNode::SubtractNode(std::shared_ptr<Node> node_a, std::shared_ptr<Node> node_b)
        : node_a(std::move(node_a)),
          node_b(std::move(node_b))
    {
    }
    ...
    MultiplyNode::MultiplyNode(std::shared_ptr<Node> node_a, std::shared_ptr<Node> node_b)
        : node_a(std::move(node_a)),
          node_b(std::move(node_b))
    {
    }
    ...
    DivideNode::DivideNode(std::shared_ptr<Node> node_a, std::shared_ptr<Node> node_b)
        : node_a(std::move(node_a)),
          node_b(std::move(node_b))
    {
    }
    ...
    PlusNode::PlusNode(std::shared_ptr<Node> node)
        : node(std::move(node))
    {
    }
    ...
    MinusNode::MinusNode(std::shared_ptr<Node> node)
        : node(std::move(node))
    {
    }
